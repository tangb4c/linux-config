...
function! PrintHelp()
    ...
    echohl WarningMsg | echo ",ev Open .vimrc" | echohl None
...
set t_Co=256
let g:rehash256 = 1
"let g:favorite_color_schemes = [ 'molokai', 'lucius', 'tir_black' ]
"let g:favorite_color_schemes = [ 'solarized', 'neon' ]
let g:favorite_color_schemes = [ 'solarized' ]
"0 - Do not use
"1 - Use, default value
...
noremap <silent> <leader>ev :call SwitchToBuf($MYVIMRC)<cr> 
...
func! SetTitle()
    ...
    if (&filetype == 'sh')
        ...
        call append(line("."), "#########################################################################")
        call append(line(".")+1, "# Author: blaketang")
